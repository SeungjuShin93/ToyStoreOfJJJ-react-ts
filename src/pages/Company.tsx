...
export function Kakao() {
  useEffect(() => {
    ...
    const iwContent =
        '<div style="padding:8px; font-size:14px">제이스 장난감 백화점</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
    ...
    <div className='flex__container'>
      ...
      <div className={styles.company__diraction}>
        <div>
          ...
          <p>부산 지하철 서면역 하차(10번 출구) &rarr; 도보 약 10분</p>
        </div>
        <div>
          <p className={styles.company__diraction__title}>버스 이용 시</p>
          <p>
            서면역 인근 버스 정류장 하차(29, 43, 52, 62, 80, 86, 103, 108, 133,
            1004, 1001, 1002) &rarr; 도보 이동
          </p>
        </div>
        <div>
          <p className={styles.company__diraction__title}>자가용 이용 시</p>
          <p>중앙대로를 따라 서면역 방향으로 직진</p>
        </div>
      </div>
    </div>
  );
