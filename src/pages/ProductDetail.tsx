...
import { getProductImagesByProductId } from '../services/productServices';
// 상품 설명 디테일 사진
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const isProductInWishlist = await getWishListsByUserAndProduct(
          Number(user?.id),
          Number(productId)
        );
